...
public class CloudSimExample6 {
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets){
		...
		for(int i=0;i<cloudlets;i++){
			cloudlet[i] = new Cloudlet(i, length*((((i+1)%5)+1)*10), pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
...
//			printCloudletList(newList);
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		Log.println("Cloudlet ID" + indent + indent + "STATUS" + indent + indent +
				"Data center ID" + indent + indent + "VM ID" + indent + indent + "Time" + indent + indent + "Start Time" + indent + indent + "Finish Time");
		...
		for (Cloudlet value : list) {
			...
			if (cloudlet.getStatus() == Cloudlet.CloudletStatus.SUCCESS) {
				...
				Log.println(indent + indent + indent + cloudlet.getResourceId() + indent + indent + indent + indent+ cloudlet.getGuestId() +
